...
// 		}
		...
		$addons = find_data( M( 'apps' )->where("type=1" )->field ( 'name,title' )->select() );
		foreach ( $addons as $a ) {
	...
	public function edit() {
		$model = $this->getModel ( 'keyword' );
		return parent::commonEdit ( $model, 0, 'common@base/edit' );
	}
	public function add() {
		$model = $this->getModel ( 'keyword' );
		
		return parent::commonAdd ( $model, 'common@base/add' );
	}
}