...
class Uploads extends Home
{
     ...
     * // 上传配置/
     * $setting = config( 'app.EDITOR_UPLOAD' );
     ...
     *
     * // 调用文件上传组件上传文件
     * $this->uploader = new Upload ( $setting, config( 'app.EDITOR_PICTURE_UPLOAD_DRIVER' ) );
    ...
    {
        if (empty($file['md5'])) {
            throw new \think\Exception('缺少参数:md5');
        }
        /* 查找文件 */
        $map = array(
            'md5' => $file['md5'],
