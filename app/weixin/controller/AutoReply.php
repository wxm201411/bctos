...
class AutoReply extends WebBase
{
    ...
    public function lists()
    {
        ...
        $list_data = $this->getModelList($this->getModel('auto_reply'), 'id desc', true);
    ...
    public function news()
    {
        ...
        $this->assign('page_tips', '请不设置相同的关键词，相同的关键词只回复最新的设置');
    ...
    public function edit()
    {
        ...
        if (IS_POST) {
            ...
            if(! is_numeric($exp_arr[1])) return $this->error('请选择素材');
            ...
            if ($res !== false) {
                return $this->success('修改成功！', U('lists'));
            } else {
                return $this->error(M('auto_reply')->getError());
            }
        } else {
    ...
    function check_keyword($key, $id = 0)
    {
        ...
        foreach ($key_arr as $k) {
            ...
            if ($count > 0) {
                return $this->error('该关键词已存在，请换一个试试');
            }
        }
    }
    ...
    public function add()
    {
        ...
        if (IS_POST) {
            ...
            if ($res) {
                return $this->success('添加关键词' . $model['title'] . '成功！', U('lists'));
            } else {
                return $this->error(M('auto_reply')->getError());
            }
        } else {
