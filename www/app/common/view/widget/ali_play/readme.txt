...
*****************************************************************************************
*                                                                                       *
*     本次更新新增即时到帐功能，用户只需到后台基本配置的时候选择即可，默认为担保交易    *
*                                                                                       *
*****************************************************************************************
...
1.插件挂载在indexAliPlay的钩子上，你放心这个钩子会在你安装插件的时候自己安装，卸载的时候也会自己卸载，你完全不用理会。
   但是如果要调用支付则在前台文件需要调用的地方添加{:W('social/indexAliPlay/render','config')}就可以了！
然后在后台配置支付宝信息。


2.目前版本基本算是一个正式版本吧！已经实现了“即时到帐”、“担保交易”俩种交易方式！但是还有好多东西都没做完善，比如：
